...
def capture_exception_evidence(
    ...
    """Capture JSON-safe, bounded exception evidence without retaining frames."""
...
def render_traceback_text(evidence: Mapping[str, object]) -> str:
    """Render captured frames and exception chain without retaining live frames."""
